...
<html lang="en">
	<head>
		...
		<title>hamrofustal |Futsal Listing</title>
		<!--Bootstrap -->
			...
			<div class="container">
				...
				<div class="header_wrap">
					...
					<div class="header_search">
						...
						<form name="search" action="searchfutsal.php" method="GET" id="header-search-form">
							<input name="text" type="text"  id="searchkey" placeholder="Search..." class="form-control">
			...
			<div class="container">
				<div class="page-header_wrap">
					<div class="page-heading">
						<h1>Futsal Listing</h1>
					</div>
					<ul class="coustom-breadcrumb">
						<li><a href="/hamrofutsal">Home</a></li>
						<li>Futsal Listing</li>
					</ul>
				</div>
			</div>
			<!-- Dark Overlay-->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-9 col-md-push-3">
						...
						<?php $sql = "SELECT addfutsal.*,location.Name,location.id as bid from addfutsal join location on location.id=addfutsal.Brand ORDER BY addfutsal.Title ASC";
							$query = $dbh -> prepare($sql);
							$query->execute();
							$results=$query->fetchAll(PDO::FETCH_OBJ);
							$cnt=1;
				...
				<aside class="col-md-3 col-md-pull-9">
					...
					<div class="sidebar_widget">
						<div class="widget_heading">
							<h5><i class="fa fa-filter" aria-hidden="true"></i> Recently Listed Futsal</h5>
						</div>
