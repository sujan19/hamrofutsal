										...
										<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
											...
											<tbody>
												...
												<?php 
													...
													$sql = "SELECT tblusers.FullName,location.Name,addfutsal.Title ,tbltestimonial.UserEmail,tbltestimonial.Testimonial,tbltestimonial.PostingDate,tbltestimonial.FutsalId as vid,tbltestimonial.status,tbltestimonial.id from tbltestimonial join addfutsal on tbltestimonial.FutsalId =addfutsal.id join tblusers on tblusers.Emailid=tbltestimonial.UserEmail join location on location.id=addfutsal.Brand  where addfutsal.UserName=:username";
													$query = $dbh -> prepare($sql);
