<?php
	...
	<html lang="en" class="no-js">
		...
		<head>
			...
			<title>hamrofutsal | Admin Dashboard</title>
												...
												<div class="panel panel-default">
													<div class="panel-body bk-success text-light">
														<div class="stat-panel text-center">
															...
															<div class="stat-panel-title text-uppercase">Listed Futsal</div>
														</div>
													</div>
													<a href="managefutsal.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
												</div>
											</div>
												...
												<div class="panel panel-default">
													<div class="panel-body bk-warning text-light">
														<div class="stat-panel text-center">
															...
															<div class="stat-panel-title text-uppercase">Location</div>
														</div>
													</div>
													<a href="manage-loc.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
												</div>
											</div>
										</div>
									</div>
