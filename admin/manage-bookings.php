										...
										<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
											...
											<tbody>
												...
												<?php
													...
													$sql = "SELECT addfutsal.Title,addfutsal.id as vid,location.Name,events.name,events.start,events.end,events.Status,events.id from events join addfutsal on events.FutsalId=addfutsal.id join location on location.id=addfutsal.Brand where addfutsal.UserName=:username";
													$query = $dbh -> prepare($sql);
